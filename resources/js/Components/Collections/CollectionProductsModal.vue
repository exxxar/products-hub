            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div v-if="loading" class="loading-state">
                        ...
                        <p>Загрузка товаров коллекции...</p>
                    </div>
                ...
                <!-- Footer -->
                <div v-if="!loading && products.length > 0" class="modal-footer">
...
export default {
    ...
    computed: {
        ...
        canEditProducts() {
            ...
            return ['manual', 'category_select'].includes(this.collection.type)
        }
    },
        ...
        async show(collection) {
            ...
            try {
                const response = await axios.get(
                    `/api/workspaces/${this.store.uuid}/collections/${collection.id}/show`
                )
                this.products = response.data.products
            } catch (error) {
                console.error('Load collection products failed:', error)
                this.$notify?.error('Ошибка при загрузке товаров')
            } finally {
                this.loading = false
            }
        },
